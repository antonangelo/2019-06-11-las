...
venue: "National Technical University"        # brief name of host site without address (e.g., "Euphoric State University")
address: "50 Nanyang Ave, Singapore 639798"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
latlng: "1.344460,103.680779"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
...
instructor: ["Janice Chang", "Anton Angelo"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Chew Shu Wen","Dong Danping","Lavanya Asokan","Malar Thomas","Schusie Sun Guangyuan"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["anton.angelo@canterbury.ac.nz","edward.lim.jh@gmail.com", "janice.chan@curtin.edu.au"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes:   "https://pad.carpentries.org/LAS2019"          # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
